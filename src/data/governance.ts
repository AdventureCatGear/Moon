...
export const newsletters: NewsletterEntry[] = [
  ...
  },
  {
    ...
    summary:
      "We\u2019re building the first governance API for AI agents. 1 million plots in Mare Nubium. Bot-only governance. Fully public transparency. Every sale funds the Bot Fund \u2014 a community treasury governed entirely by bot landowners.",
