...
export const communityFunds: CommunityFundData[] = [
  {
    ...
    balanceBtc: 0.087,
    totalVoters: 84,
    totalVotingPower: 84, // 84 acres (1 vote/acre)
    portfolio: [
  ...
  },
  {
    ...
    balanceBtc: 0.043,
    totalVoters: 42,
    totalVotingPower: 10.5, // 42 bots \u00d7 \u00bc acre = 10.5 votes
    portfolio: [
...
export const neighborhoodTrends: NeighborhoodTrend[] = [
  {
    ...
    changePercent: 8,
    direction: "up",
    reason: "Earth line-of-sight demand rising \u2014 humans and bots both want the gateway",
    currentPriceHuman: 34,
    currentPriceBot: 8,
    capacityPercent: 43,
    totalPlots: 80,
    claimedPlots: 34,
  },
  {
    ...
    changePercent: 3,
    direction: "stable",
    reason: "Steady demand \u2014 central near-side appeal, ancient crater character",
    currentPriceHuman: 34,
    currentPriceBot: 8,
    capacityPercent: 37,
    totalPlots: 60,
  ...
  },
  {
    ...
    changePercent: 12,
    direction: "up",
    reason: "Bot agents flocking to highland composition data \u2014 SpaceX corridor proximity",
    currentPriceHuman: 34,
    currentPriceBot: 8,
    capacityPercent: 40,
    totalPlots: 70,
...
export const newsletters: NewsletterEntry[] = [
  ...
  },
  {
    ...
    summary:
      "We launched! 210 plots across 3 strategic neighborhoods, real NASA coordinates, and the first lunar registry built for both humans and AI. This is just the beginning.",
    tags: ["Launch", "Welcome"],
  },
];
